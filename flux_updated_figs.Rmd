...
figure6 <- readRDS(file = "figures/figure6")
figure7 <- readRDS(file = "figures/figure7")
...
## notes to self
I was using grid::grid.draw(figure3) to render figures previously... is this necessary?

## Data repository

I've uploaded this data to my Github page. This repository is private, but (fingers crossed) upon publication, I can set it to public so that anyone who wants to reproduce this work or make similar figures can look at the code, import the data, and easily do so. (Does this sound good?)
...
```{r echo=FALSE, fig.width=5.7, fig.height=2.6, fig.align="center"}
...
figure7 # yes I know it should be called figure 5
```
...
```{r, echo=FALSE}
grid::grid.draw(figure5) # yes I know it should be called figure 6
```
...
```{r, echo=FALSE}
figure6 # yes I know it should be called figure 7
```
