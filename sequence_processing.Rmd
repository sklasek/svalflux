...
---
Take a look at Rmarkdown examples
Long step:
...
I have not changed anything about the previous chunk! 
...
asv.table
ps.fr <- subset_taxa(ps.f, (Kingdom!="Eukaryota")) # 448 unknown and eukaryote ASVs removed
...
ntaxa(ps.f)-ntaxa(ps.fr) # in total, 514 taxa removed 
ps.fr

# decontam using the combined approach, which combines the scores from prevalence and frequency using Fisher's method. 
library(decontam) 
...
table(contamdf.flux.comb$contaminant) # only 82 are contaminants now
flux.comb.contam <- (which(contamdf.flux.comb$contaminant))
flux.comb.contam.mx <- subset(tax_table(ps.fr)[flux.comb.contam,])
flux.comb.contam.mx # when rerunning: go to line 341 to remove contaminants
# how many contaminant ASVs belong to a particular taxonomy (say, ANME-1?)
which(flux.comb.contam.mx[,6]=="Enhydrobacter")
which(flux.comb.contam.mx[,6]=="Pseudomonas")
which(flux.comb.contam.mx[,6]=="Flavobacterium")
which(flux.comb.contam.mx[,6]=="Streptococcus")
which(flux.comb.contam.mx[,6]=="Escherichia-Shigella")
which(flux.comb.contam.mx[,6]=="Micrococcus")
which(flux.comb.contam.mx[,6]=="Kocuria")
which(flux.comb.contam.mx[,5]=="Comamonadaceae")
which(flux.comb.contam.mx[,5]=="Micrococcaceae")
which(flux.comb.contam.mx[,5]=="Erythrobacteraceae")
which(flux.comb.contam.mx[,6]=="Brachybacterium")
```