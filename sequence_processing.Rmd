...
ord16 <- plot_ordination(ps.vst.pos, ord.ps.vst.uni.nmds, color = "stage", title = "vst unweighted Unifrac NMDS, stress=0.105") # same ordination as ord11
nmdsord2 <- ord16+stat_ellipse() # this one is useful too
