...
# 16S sequence processing and decontamination (not analysis)
I haven't run this yet. This code has been nearly-all copy-pasted from sequence_processing.Rmd but formatted so that it's somewhat readable. I'll mark this down before publication to get the .md document.
